...
st.write(''' 
         ...
         lage ulike verktøy knyttet til helhetlig energiplanlegging og bergvarme. Er engasjert i fagfeltet 
         og søker kontinuerlig etter effektive og innovative løsninger.
         ''')
